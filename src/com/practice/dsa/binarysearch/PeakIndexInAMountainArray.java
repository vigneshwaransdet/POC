...
public class PeakIndexInAMountainArray {
	...
	public void test1() {
		int[] arr = {0,1,0};
		Assert.assertEquals(findPeakElement(arr), 1);
	}
	
	@Test
	public void test2() {
		int[] arr = {0,2,1,0};
		Assert.assertEquals(findPeakElement(arr), 2);
	}
	
	@Test
	public void test3() {
		int[] arr = {0,10,5,2};
		Assert.assertEquals(findPeakElement(arr), 10);
	}
	
	@Test
	public void test4() {
		int[] arr = {3,4,5,1};
		Assert.assertEquals(findPeakElement(arr), 5);
	}
